#+TAGS: Analysis(a) DataScience(D) NLP(N) Software_Development(S) Society(s) Philosophical(P) PyTorch(p) fastai (f) tensorflow(t)
...
**** https://towardsdatascience.com/no-machine-learning-is-not-just-glorified-statistics-26d3952234e3 :Philosophical:
